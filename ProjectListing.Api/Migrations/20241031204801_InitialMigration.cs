    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeProjects", x => new { x.Id_Project, x.Id_Employee });
                    table.ForeignKey(
                        name: "FK_EmployeeProjects_Employees_Id_Employee",
                        column: x => x.Id_Employee,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeProjects_Projects_Id_Project",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeProjects_Id_Employee",
